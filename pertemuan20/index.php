				...
				<div class="card">
					<div class="card-content">
						<div class="px-3 py-3">
							...
							<a href="tambah.php" target="_blank"><button type="button" class="btn btn-danger">Tambah Data</button></a>
							<a href="logout.php"><button type="button" class="btn btn-warning">Log Out</button></a>
							<a href="cetak.php" target="_blank"><button type="button" class="btn btn-secondary">Cetak</button></a><br><br>

							<form action="" method="post">
								<td><input type="text" name="keyword" id="keyword" class="inputz" placeholder="Masukkan Keyword Pencarian" autocomplete="off" autofocus><button type="submit" name="cari" id="tombol-cari" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button><img src="img/loader.gif" class="loader" alt="Icon Loader"></td>
							</form><br>
									...
									<table class="table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th scope="col" style="background-color: #F6F3F3; padding-top: 12px; padding-bottom: 12px; text-align: center;">Aksi</th>
											</tr>
										</thead>
										<tbody>
											<?php $i = 1; ?>
											<?php foreach ($anime as $anm) : ?>
												<tr>
													...
													<td>
														<div class="td-action">
															<a href="edit.php?id=<?= $anm["id"]; ?>" target="_blank"><i class="fa-regular fa-pen-to-square fa-lg"></i></a>
