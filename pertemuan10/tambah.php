							...
							<form action="" method="post">
								<div class="table-responsive">
									<table class="table" cellpadding="10" cellspacing="0">
										...
										<tbody>
											<tr>
												<td scope="row" style="text-align: center;"><input type="text" name="judul" id="judul" placeholder="Masukan Judul" required></td>
												<td scope="row" style="text-align: center;"><input type="text" name="skor" id="skor" placeholder="Masukan Skor" required></td>
											</tr>
										</tbody>
										<thead>
										    <tr>
										...
										<tbody>
											<tr>
												<td scope="row" style="text-align: center;"><input type="text" name="rilis" id="rilis" placeholder="Masukan Tanggal Rilis" required></td>
												<td scope="row" style="text-align: center;"><input type="text" name="studio" id="studio" placeholder="Masukan Studio" required></td>
											</tr>
										</tbody>
										<thead>
										    <tr>
										...
										<tbody>
											<tr>
												<td scope="row" style="text-align: center;"><input type="text" name="genre" id="genre" placeholder="Masukan Genre" required></td>
												<td scope="row" style="text-align: center;"><input type="text" name="gambar" id="gambar" placeholder="Masukan Gambar" required></td>
											</tr>
										</tbody>
									</table>
								</div>
